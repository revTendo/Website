// Pre-load the sounds
const pressSound = new Audio('webfs/sfx/wiiu/WAV_240_GUESS_BANK_MEN.wav');
const releaseSound1 = new Audio('webfs/sfx/wiiu/WAV_244_GUESS_WARC_1_GUESS_GROUP_MEN.wav');
const releaseSound2 = new Audio('webfs/sfx/wiiu/WAV_247_GUESS_WARC_1_GUESS_GROUP_MEN.wav');
const releaseSound3 = new Audio('webfs/sfx/wiiu/WAV_245_GUESS_WARC_1_GUESS_GROUP_MEN.wav');
